/**
 * GraphQL queries for gene retrieval by different criteria.
 *
 * This module defines multiple query shapes for fetching genes by:
 * - term search (`GET_GENE_BY_TERM`)
 * - table filters (`GET_GENE_TABLE_BY_FILTERS`)
 * - identifier (`GET_GENE_BY_ID`)
 */
