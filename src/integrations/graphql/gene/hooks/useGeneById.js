/**
 * Hook to fetch detailed information for a single gene by its ID.
 *
 * Executes the `GET_GENE_BY_ID` GraphQL query and maps the raw gene record
 * into a fully detailed object.
 * Handles loading, errors, and empty results consistently, returning
 * a normalized object.
 */
